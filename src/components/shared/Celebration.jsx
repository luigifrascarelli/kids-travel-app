...
export function BadgeCelebration({ badge, onDone }) {
  ...
  return (
    <>{<Confetti />}
      <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 300, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(13,45,79,0.75)", WebkitBackdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", backdropFilter: "blur(8px)", animation: "fadeIn 0.3s ease" }}>
