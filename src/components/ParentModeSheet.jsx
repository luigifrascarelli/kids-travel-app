...
export function ParentModeSheet({ onClose }) {
  ...
  return (
    <>
      <div onClick={onClose} style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 300, background: "rgba(13,45,79,0.65)", WebkitBackdropFilter: "blur(4px)", backdropFilter: "blur(4px)" }} />
