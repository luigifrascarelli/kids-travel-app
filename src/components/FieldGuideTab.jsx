...
export function DetailSheet({ item, zone, onClose }) {
  ...
  return (
    <>
      <div onClick={onClose} style={{ position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 100, background: "rgba(13,45,79,0.5)", backdropFilter: "blur(4px)", animation: "fadeIn 0.2s ease" }} />
